...
if ((event.body.toLowerCase() == "chumma de") || (event.body.toLowerCase() == "kiss me")) {
  ...
  if ((event.body.toLowerCase() == "🤔") || (event.body.toLowerCase() == "🤔🤔")) {
   ...
   if ((event.body.toLowerCase() == "bot hume kon banaya") || (event.body.toLowerCase() == "tume kis ne banaya hai")) {
     return api.sendMessage("🌸=देव बाबू ne.", threadID);
   };

  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon hai")) {
     return api.sendMessage("🌸= देव बाबू ", threadID);
   };

   if ((event.body.toLowerCase() == "uff") || (event.body.toLowerCase() == "UFF")) {
     return api.sendMessage("🌸== हाए_🙃तेरी मासूमियत उफ़ मेरा देव बाबू बॉस फिदा हो जाएगा__❤️ 🤸‍♂️ __ 😘", threadID);
   };
...
((event.body.toLowerCase() == "khana hua") || (event.body.toLowerCase() == "diner hua")) {
   ...
   if ((event.body.toLowerCase() == "😝") || (event.body.toLowerCase() == "😝")) {
     return api.sendMessage("️ जुबान अंदर करो वरना अपने_देव_❤️-बाबू  से कहकर अंदर करवा दूंगा 🤸‍♂️😸.", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "does the bot love you") || (event.body.toLowerCase() == "does the bot love you")) {
     return api.sendMessage("🌸====『*★᭄𝗖𝗿𝗲𝗱𝗶𝘁'𝘀  ཫ༄𒁍≛🥰dev बाबू❤️ *★᭄ ཫ༄𒁍≛ 』====🌸__💙 Yes I love you and everyone so much", threadID);
   };

   if ((event.body.toLowerCase() == "bot go to sleep") || (event.body.toLowerCase() == "bot goes to sleep")) {
     return api.sendMessage("🌸====『*★᭄𝗖𝗿𝗲𝗱𝗶𝘁'𝘀  ཫ༄𒁍≛dev❤️बाबू❤ *★᭄ ཫ༄𒁍≛ 』====🌸__💙I'm a bot, you're the one who should go to sleep <3", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ASALAMU ALAIKUM") || (event.body.toLowerCase() == "har har mahadev")) {
     return api.sendMessage(" jai shri mahakal🔱😘", threadID);
   };
